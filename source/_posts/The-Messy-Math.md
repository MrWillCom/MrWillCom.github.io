...
一门如此追求思维美学的学科，怎么能构建出如此杂乱的表达？这时候，我就必须提起计算机语言了，计算机语言的表达与数学表达比起来，严谨得不止一点。主流的语言往往有统一的标准，表达和命名都有严格的规定，然而数学没有。年轻的计算机语言没有厚重的历史包袱，使得它可以构建全新的语法，从而摆脱以往语言存在但受制于历史原因而无法解决的问题。可是，数学语言在历史发展中已然成型，其问题不能被轻易解决，原因在于有太多信息已然在它的基础之上建立好了，所以数学语言无法承担颠覆性的变革。更何况数学语言没有版本体系，自然谈不上什么更新迭代了。
